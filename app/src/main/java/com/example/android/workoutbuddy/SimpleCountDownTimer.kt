...
import com.example.android.workoutbuddy.database.Checkbox
...
class SimpleCountDownTimer(
    ...
    private fun finish() {
        onCountDownListener.onCountDownFinished(false)
        finished = true
        pause()
    }
...
//            onCountDownListener.updateViewModel()
    ...
    /**
     * A method to cancel countdown
     */
    fun cancel() {
        handler.removeCallbacks(runnable)
        onCountDownListener.onCountDownFinished(true)
        finished = true
    }
